    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= lang('city_form') ?></h5>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label"><?= lang('city_name') ?></label>
                    <div class="col-lg-9">
                            ...
                            swal({
                                ...
                                function () {
                                    if(typeof dt_DataTable !== 'undefined' ) {
                                        ...
                                        var option = new Option(resObj.city_name, resObj.city_id, true, true);
                                        $('#CityList').append(option).trigger('change');
                                    }
                            });
                        }else{
                            swal({
