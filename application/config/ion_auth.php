...
$config['tables']['groups']          = 'tbl_groups';
$config['tables']['users_groups']    = 'tbl_users_groups';
...
$config['multiple_user_check']        = FALSE;               // To enable multiple user login
/*
 | -------------------------------------------------------------------------
 | Cookie options.
 | -------------------------------------------------------------------------
